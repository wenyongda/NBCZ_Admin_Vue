...
<template>
  <div class="content-main">
    ...
    <Card>
      ...
      <Table ref="tables" border :data="tableData1" v-bind:columns="tableColumns1" stripe>
        <template slot-scope="{ row, index }" slot="action">
          <Button v-if="userAccess.isAuth" type="default" size="small" icon="md-key" style="margin-right: 5px"
            @click="handlePermission(row)">授权</Button>
    ...
    <Modal title="授权" :mask-closable="false" v-model="modelPermission" width="300" scrollable footer-hide>
